...
export const demoLeads: Lead[] = [
  ...
  { id: '9', company: 'Harbor Dental Partners', website: 'harbordental.example', industry: 'Healthcare Services', location: 'Tampa, United States', revenue: 3_400_000, employees: 28, contactName: 'Elena Ruiz', contactTitle: 'Office Manager', email: 'front-desk-at-harbor', phone: '+1 813 555 0177', lastUpdated: '2026-08-18', inQueue: false },
  { id: '10', company: 'Summit Roofing Co.', website: 'summitroofing.example', industry: 'Commercial Services', location: 'Dallas, United States', revenue: 1_650_000, employees: 18, contactName: 'Tom Ellison', contactTitle: 'Owner', email: 'tom@summitroofing.example', phone: '+1 214 555 0128', lastUpdated: '2026-08-21', inQueue: false },
]
